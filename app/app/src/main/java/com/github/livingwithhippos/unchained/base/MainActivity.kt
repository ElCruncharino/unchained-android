...
class MainActivity : AppCompatActivity() {
    ...
    // tracks the progress of the latest download enqueued in the system download manager on TV
     ...
     * user gets no feedback at all after starting a download (see issue #376). The progress is
     * polled every second and shown in a snackbar until the download ends. Does nothing on non-TV
     * devices, where the system notifications already cover this. Only the latest enqueued
     * download is tracked.
     */
